...
const posts = [
  ...
  { slug: 'physical-models-vs-renderings-animation-ar-vr', title: 'Physical Models vs. 3D Renderings, Animation, AR and VR: What Each Communicates Best', description: 'Physical models, renderings, animation, AR, and VR communicate different aspects of a design. Learn which medium is best for atmosphere, sequence, immersion, real-world context, and shared spatial understanding—and when they work best together.', pubDate: new Date('2026-08-11') },
